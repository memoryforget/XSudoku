...
void Diagdoku::load(const char* const filename)
//从res文件中读取 
{
...
bool Diagdoku::legal(int x, int y)
//一个坐标是否合法 
{
...
void Diagdoku::generate_cnf(const char* const filename)
//根据Sudoku生成对应的cnf 
{
...
void Diagdoku::randomGenerate(int n)
//生成随机数独题目，n为提示数 
{
	int i, j, m;
	bool broke;
